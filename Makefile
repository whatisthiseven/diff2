#############################################################################
# Makefile for building: crave-qt
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  crave.pro
# Template: app
# Command: C:\Qt\5.3.2\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile crave.pro
#############################################################################
...
Makefile: crave.pro ../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../Qt/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile crave.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:\crave\src\leveldb\libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:\crave\src\leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\crave\crave-qt_plugin_import.cpp

C:/crave/src/leveldb/libleveldb.a: FORCE
