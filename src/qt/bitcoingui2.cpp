...
#endif
    setObjectName("crave");
    setStyleSheet("#crave { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #e8e8e8, stop: 1 #e8e8e8);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/node"), tr("&Crave Node"), this);
    masternodeManagerAction->setToolTip(tr("Show Crave Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    richListPageAction = new QAction(QIcon(":/icons/rlist"), tr("&Rich List"), this);
    richListPageAction->setToolTip(tr("Show top Crave balances."));
