...
bool CWallet::AddCraveNodeConfig(CCraveNodeConfig nodeConfig)
{
    bool rv = CWalletDB(strWalletFile).WriteCraveNodeConfig(nodeConfig.sAlias, nodeConfig);
    if(rv)
	uiInterface.NotifyCraveNodeChanged(nodeConfig);
